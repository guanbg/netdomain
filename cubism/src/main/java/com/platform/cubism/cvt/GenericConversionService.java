...
public class GenericConversionService implements ConfigurableConversionService {
	...
	private static final Logger logger = LoggerFactory.getLogger(GenericConversionService.class);
	...
	private GenericConverter findConverterForClassPair(TypeDescriptor sourceType, TypeDescriptor targetType) {
		...
		if (sourceObjectType.isInterface()) {
			...
			while (!classQueue.isEmpty()) {
				...
				Class<?> componentType = ReflectionUtils.resolvePrimitiveIfNecessary(currentClass.getComponentType());
