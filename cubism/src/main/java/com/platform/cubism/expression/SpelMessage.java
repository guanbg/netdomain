...
public enum SpelMessage {
	...
	CANNOT_INDEX_INTO_NULL_VALUE(Kind.ERROR, 1012, "Cannot index into a null value"), NOT_COMPARABLE(Kind.ERROR, 1013, "Cannot compare instances of {0} and {1}"), //
	...
	PROBLEM_LOCATING_METHOD(Kind.ERROR, 1031, "Problem locating method {0} cannot on type {1}"), SETVALUE_NOT_SUPPORTED(Kind.ERROR, 1032,
	...
	MORE_INPUT(Kind.ERROR, 1041, "After parsing a valid expression, there is still more data in the expression: ''{0}''"), RIGHT_OPERAND_PROBLEM(Kind.ERROR, 1042,
			"Problem parsing right operand"), NOT_EXPECTED_TOKEN(Kind.ERROR, 1043, "Unexpected token.  Expected ''{0}'' but was ''{1}''"), OOD(Kind.ERROR, 1044,
