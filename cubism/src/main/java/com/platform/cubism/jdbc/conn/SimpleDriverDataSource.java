...
public class SimpleDriverDataSource extends AbstractDriverBasedDataSource {
	...
	public SimpleDriverDataSource(Properties conProps) {
		Assert.notNull(conProps);
		String drivername = conProps.getProperty("driver");
		Driver driverclass = (Driver) ReflectionUtils.instantiateClass(drivername);
	...
	public void setDriverClass(Class<? extends Driver> driverClass) {
		this.driver = ReflectionUtils.instantiateClass(driverClass);
	}
