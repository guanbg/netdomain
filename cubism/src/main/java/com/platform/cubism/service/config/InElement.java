...
public class InElement {
	...
	public InElement addFld(FldElement fld) {
		if (this.fld == null) {
	...
	public InElement addStc(StcElement stc) {
		if (this.stc == null) {
	...
	public InElement addArr(ArrElement arr) {
		if (this.arr == null) {
	...
	public void addOverrides(InElement other) {
		if (other == null) {
			return;
		}
	...
	public String toString(int level) {
		...
		sb.append(getTabSpace(level)).append("</in>");
		return sb.toString();
	}
