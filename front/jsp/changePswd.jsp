      ...
      <div class="modal-body">
      	<div class="padding-lr-20">
			...
			<span class="input-group">
				<label class="input-group-addon no-padding-right input-group-addon-label" for="email">原有密码：</label>
				<input type="password" id="oldpswd" class="form-control userpswd" placeholder="原有密码必须输入">
			</span>
			<div class="space-4"></div>
			<span class="input-group">
				<label class="input-group-addon no-padding-right input-group-addon-label" for="email">新设密码：</label>
				<input type="password" id="newpswd" class="form-control userpswd" placeholder="新设密码必须输入">
			</span>
			<div class="space-4"></div>
			<span class="input-group">
				<label class="input-group-addon no-padding-right input-group-addon-label" for="email">确认密码：</label>
